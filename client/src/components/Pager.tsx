...
/**
 * Position first, controls second: "21–40 of 137" answers "where am I?" without
 * making the user count pages. Page *numbers* are deliberately absent — with 20
 * per page they buy nothing and cost a row of buttons.
 */
export default function Pager({ noun, total, offset, limit, busy, onPage }: PagerProps) {
  ...
  // Clamped, because `offset` can outrun `total` if rows disappear between
  // requests — "141–160 of 137" is the kind of thing QA screenshots.
